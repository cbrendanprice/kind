...
If you have [go] 1.16+ and [docker] or [podman] installed `go install github.com/cbrendanprice/kind@{{< stableVersion >}} && kind create cluster` is all you need!
...
You can install kind with `go install github.com/cbrendanprice/kind@{{< stableVersion>}}` (for [go] [1.17+][go-supported]). This will put `kind` in
...
<!--links-->
[kind]: https://github.com/cbrendanprice/kind
[go]: https://golang.org/
